...
/* ============================================================
   CORE SPLIT HANDSHAKE - PART 2 READY
   ============================================================ */
window.PokeMisteryRL_CoreBridge = window.PokeMisteryRL_CoreBridge || {};
if (!window.PokeMisteryRL_CoreBridge.part1Ready) {
  throw new Error("PokeMisteryRL CORE PART 1 non caricato prima di CORE PART 2");
}
